...
module.exports = SolidityTypeBytes;
    ...
    along with fourtwenty.js.  If not, see <http://www.gnu.org/licenses/>.
*/
/** 
 * @file coder.js
...
/*
    This file is part of fourtwenty.js.

    fourtwenty.js is free software: you can redistribute it and/or modify
    it under the terms of the GNU Lesser General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    fourtwenty.js is distributed in the hope that it will be useful,
...
module.exports = function (str, isNew) {
    if (str.substr(0, 2) === '0x' && !isNew) {
        ...
        console.warn('see https://github.com/420integrated/go-420coin/web3.js/pull/205');
...
web3.fourtwenty.isSyncing = function (callback) {
    return new IsSyncing(callback);
};

/*jshint maxparams:4 */
web3.fourtwenty.filter = function (fil, callback) {
    return new Filter(fil, watches.fourtwenty(), formatters.outputLogFormatter, callback);
};
/*jshint maxparams:3 */
...
// ADD defaultblock
Object.defineProperty(web3.fourtwenty, 'defaultBlock', {
    get: function () {
...
Object.defineProperty(web3.fourtwenty, 'defaultAccount', {
    get: function () {
...
setupMethods(web3.fourtwenty, fourtwenty.methods);
setupProperties(web3.fourtwenty, fourtwenty.properties);
...
AllSolidityEvents.prototype.execute = function (options, callback) {
    ...
    return new Filter(o, watches.fourtwenty(), formatter, callback);
};
...
var checkForContractAddress = function(contract, abi, callback){
    ...
    // wait for receipt
    var filter = web3.fourtwenty.filter('latest', function(e){
        if(!e && !callbackFired) {
            count++;
            ...
            if(count > 50) {
                ...
                web3.fourtwenty.getTransactionReceipt(contract.transactionHash, function(e, receipt){
...
ContractFactory.prototype.new = function () {
    ...
    if(callback) {
        ...
        web3.fourtwenty.sendTransaction(options, function (err, hash) {
            if (err) {
                callback(err);
            } else {
        ...
        var hash = web3.fourtwenty.sendTransaction(options);
        // add the transaction hash
        contract.transactionHash = hash;
...
SolidityFunction.prototype.call = function () {
    ...
    if (!callback) {
        var output = web3.fourtwenty.call(payload, defaultBlock);
        return this.unpackOutput(output);
    } 
        
    var self = this;
    web3.fourtwenty.call(payload, defaultBlock, function (error, output) {
...
SolidityFunction.prototype.sendTransaction = function () {
    ...
    if (!callback) {
        return web3.fourtwenty.sendTransaction(payload);
    }

    web3.fourtwenty.sendTransaction(payload, callback);
};
...
SolidityFunction.prototype.estimateSmoke = function () {
    ...
    if (!callback) {
        return web3.fourtwenty.estimateSmoke(payload);
    }

    web3.fourtwenty.estimateSmoke(payload, callback);
};
...
SolidityFunction.prototype.request = function () {
    ...
    return {
        method: this._constant ? 'fourtwenty_call' : 'fourtwenty_sendTransaction',
        callback: callback,
        params: [payload], 
        format: format
    };
...
var HttpProvider = function (host) {
    this.host = host || 'http://localhost:6174';
};
...
/**
 * Fourtwenty methods and properties
 *
...
var blockCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? "fourtwenty_getBlockByHash" : "fourtwenty_getBlockByNumber";
};

var transactionFromBlockCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'fourtwenty_getTransactionByBlockHashAndIndex' : 'fourtwenty_getTransactionByBlockNumberAndIndex';
};

var uncleCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'fourtwenty_getUncleByBlockHashAndIndex' : 'fourtwenty_getUncleByBlockNumberAndIndex';
};

var getBlockTransactionCountCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'fourtwenty_getBlockTransactionCountByHash' : 'fourtwenty_getBlockTransactionCountByNumber';
};

var uncleCountCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'fourtwenty_getUncleCountByBlockHash' : 'fourtwenty_getUncleCountByBlockNumber';
};

/// @returns an array of objects describing web3.fourtwenty api methods

var getBalance = new Method({
    name: 'getBalance',
    call: 'fourtwenty_getBalance',
    params: 2,
...
/// @returns an array of objects describing web3.fourtwenty api properties
...
var transferToAddress = function (from, to, value, callback) {
    return web3.fourtwenty.sendTransaction({
        address: to,
        from: from,
        value: value
    }, callback);
...
web3.fourtwenty.contract = require('./lib/web3/contract');
web3.fourtwenty.namereg = namereg.namereg;
web3.fourtwenty.ibanNamereg = namereg.ibanNamereg;
web3.fourtwenty.sendIBANTransaction = require('./lib/web3/transfer');
web3.fourtwenty.iban = require('./lib/web3/iban');
